...
By default my config is using DirectX 11 hardware decoding. To deactivate it just remove <kbd>gpu-api=d3d11<\kbd> 
  and <kbd>hwdec=d3d11va<\kbd> from the config.
